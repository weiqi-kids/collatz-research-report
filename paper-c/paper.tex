...
\paragraph{Status of the rigorous results.}
The continued-fraction arithmetic underlying
Theorem~\ref{thm:cf}---identifying $65/41$ as the smallest-denominator
above-approximation of $\log_2 3$ for $T \leq 93$, with the next
improvement at $T = 94$---is a routine computation from the
convergents of $\log_2 3$ tabulated in OEIS~A005664~\cite{OEIS-A005664},
and the cycle-element corollary recasts an observation of
Crandall~\cite{Crandall1978}.  Neither rigorous result is novel
\emph{as a theorem of Diophantine arithmetic}; we include them because
the empirical Collatz conjecture
(Conjecture~\ref{conj:65-41}) is precisely the statement that this
deterministic arithmetic floor is realized by actual orbits, and
making that assertion meaningful requires both bookend theorems to be
on the page.  The genuinely novel content of this paper is the
empirical conjecture itself and the search procedure of
Section~\ref{sec:exp} that supports it.
...
\bottomrule
\end{tabular}
\caption{The first nine principal convergents of $\log_2 3$ (denominator
sequence is OEIS~A005664~\cite{OEIS-A005664}).  The
...
The strong form $\geq 233/147$ in Conjecture~\ref{conj:65-41} is what
...
\bibitem{OEIS-A005664}
The OEIS Foundation Inc.,
\emph{The On-Line Encyclopedia of Integer Sequences},
sequence A005664: ``Denominators of convergents to $\log_2 3$,''
\url{https://oeis.org/A005664}.
